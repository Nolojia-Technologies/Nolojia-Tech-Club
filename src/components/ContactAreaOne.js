        ...
        <div className='container'>
          <div className='contact-inner-1'>
            ...
            <div className='row'>
              ...
              >
                <img className='w-100' src='assets/img/cnt1.jpg' alt='img' />
              </div>
              <div
              ...
              >
                <div className='section-title mb-0'>
                  ...
                  <p className='content'>
                    We are ready to answer all your questions, whether you are curious about features, free trials, or even pricing.
                  </p>
                  <form className='mt-4'>
                    <div className='row'>
